...
IMAGE_PATH = os.path.join(BASE_DIR, 'Single_player', 'images', 'button_single_player.png')

start_img = pygame.image.load(IMAGE_PATH).convert_alpha()


# quit_img = pygame.image.load("images/button_multi_player.png").convert_alpha()

BASE_DIR = os.path.dirname(__file__)  # Get directory of main.py
IMAGE_PATH = os.path.join(BASE_DIR, 'Single_player', 'images', 'button_multi_player.png')

quit_img = pygame.image.load(IMAGE_PATH).convert_alpha()
